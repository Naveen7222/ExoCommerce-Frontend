...
import { promoteUserToAdmin } from "../services/api";
...
export default function PromoteUser() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await promoteUserToAdmin(email.trim());
            setSuccess(response || "User promoted to ADMIN successfully");
            ...
            if (err.response?.status === 404) {
                ...
                setError(err.response?.data || "User is already an admin");
